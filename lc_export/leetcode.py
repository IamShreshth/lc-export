...
from lc_export.leetcode_graphql import GRAPHQL_URL, question_detail_json, Problem
from lc_export.leetcode_rest import (
    BASE_URL,
    LOGIN_URL,
    SUBMISSIONS_API_URL,
    Submission,
)
from lc_export.utils import (
...
class LeetCode(object):
    ...
    def set_cookies(self, cookies: str) -> bool:
        ...
        if not valid_cookies:
            logging.error(
                "Cookie format not valid. Expected to contain at least: 'LEETCODE_SESSION=value'"
            )
            return False
    ...
    def is_user_logged(self) -> bool:
        ...
        if "LEETCODE_SESSION" in cookie_dict:
